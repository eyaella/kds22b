...
private Document doc;
	...
	public DOM() {
		...
		JLabel lblNewLabel = new JLabel("Antal program: " + loadAllPrograms().size());
		lblNewLabel.setBounds(5, 5, 440, 28);
		contentPane.add(lblNewLabel);

		
	programsList = loadAllPrograms();
	JComboBox comboBox = new JComboBox();
	comboBox.setBounds(12, 124, 439, 28);
